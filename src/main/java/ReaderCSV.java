    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            for(int i=0;i<myreader.molecules.size();i++){
                writer.print(myreader.molecules.get(i).elements[0] + "," + myreader.molecules.get(i).elements[1] + "," + myreader.molecules.get(i).elements[2] + "," + myreader.molecules.get(i).elements[3] + "," + myreader.molecules.get(i).elements[4] + "," + myreader.molecules.get(i).Natoms + "," + myreader.molecules.get(i).Density + ",");
